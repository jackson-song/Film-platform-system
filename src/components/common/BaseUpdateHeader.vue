...
<!--        <li v-for="type in moduleTypes"
    ...
    <div class="element-button">
      <div>
        <el-dropdown>
          <span>{{this.user.username }}</span><i class="el-icon-arrow-down" style="margin-left: 5px"></i>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="logout">退出登录</el-dropdown-item>
            <el-dropdown-item @click.native="handle">用户信息</el-dropdown-item>
            <el-dropdown-item @click.native="myShelf">我的书架</el-dropdown-item>
<!--            <el-dropdown-item @click.native="register"></el-dropdown-item>-->
