    ...
    public static double[][] computeSM(double[][] ratingsM) {
        ...
        for (int i = 0; i < UserNum - 1; i ++ ) {
            ...
            for (int j = i + 1; j < UserNum; j ++ ){
                ...
                for (int k = 0; k < ratingsM[i].length; k ++ ) {
//                    if (k == 6) {
//                        System.out.println("k==6" + ratingsM[i][k]  + " " + ratingsM[j][k]);
//                    }
                ...
                if(j == 3)
                    System.out.println("j == 5" + dotProduct + " " + Math.sqrt(normI * normJ));
                if (normI > 0 && normJ > 0) {
